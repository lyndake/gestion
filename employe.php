<?php include('connection.php');
	...
	$sql="INSERT INTO employe (nom,prenom,email,telephone) 
   ...
   if (isset($_GET['id'])){
	$update="SELECT * FROM employe WHERE id=".$_GET['id'];
	$res=mysqli_query($link,$update);
	$dataU=mysqli_fetch_array($res);
}

if (isset($_GET['sup'])){
	$delete="DELETE FROM employe WHERE id=".$_GET['sup'];
	...
	<span>
		...
		<div class="container">
			<div class="well" id="tete">
				<legend style="color: #C44C51">Enregistrement de salaries</legend>
			</div>
			<div class="well">
				...
				<a href="employe.php"><button name="" type="button" class="btn btn-warning">annuler</button></a>
