<?php include('connection.php');
	...
	$sql="INSERT INTO fournisseur (nom,prenom,email,telephone) 
   ...
   if (isset($_GET['id'])){
	$update="SELECT * FROM fournisseur WHERE id=".$_GET['id'];
	$res=mysqli_query($link,$update);
	$dataU=mysqli_fetch_array($res);
}

if (isset($_GET['sup'])){
	$delete="DELETE FROM fournisseur WHERE id=".$_GET['sup'];
...
<span>
		...
		<div class="container">
			<div class="well" id="tete">
				<legend style="color: #C44C51">Enregistrement des fournisseurs</legend>
			</div>
			<div class="well">
				<div class="form-group">
					<label for="">nom:</label>
					<input type="text" class="form-control" name="nom" required value="<?php if (isset($_GET['id'])) echo $dataU['nom']; ?>">
				</div>
				<div class="form-group">
					<label for="">prenom:</label>
					<input type="text" class="form-control" name="prenom" value="<?php if (isset($_GET['id'])) echo $dataU['prenom']; ?>">
				</div>
				<div class="form-group">
				...
				<a href="fournisseur.php"><button name="" type="button" class="btn btn-warning">annuler</button></a>
